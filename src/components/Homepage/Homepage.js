...
const Homepage = () => {
	...
	return (
		<div>
			<div>
				<Typography variant="h2">Use My Tech</Typography>
			...
			<StyledWrapper>
				<StyledBanner>
					...
					<StyledP>
						...
						Maybe you want to film a wedding, or scout out some properties. If
						you rented this, you could be in the air in no time!
					</StyledP>
